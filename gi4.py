...
#gye = LINE()
gye = LINE('EuFbJ6jYSizyxxso0Ae7.7NpEwRfre4u3YeFZ46fsfW.phJPMHMw2ceIP65JKROL0NwZ9vS577OKW777TqWTmnQ=')
gye.log("Auth Token : " + str(gye.authToken))
gye.log("Timeline Token : " + str(gye.tl.channelAccessToken))

#ais = LINE()
ais = LINE('Eu4A9BVxJpC8JK95xVE1.v5e2pzIr/vTl1S6SSIih0q.fcABNkRxas0zmT64+BLmNipNKWHYemysC/K5u23FPbY=')
ais.log("Auth Token : " + str(ais.authToken))
ais.log("Timeline Token : " + str(ais.tl.channelAccessToken))

#ki2 = LINE()
ki2 = LINE('EuzL0r2dYa6dwnmAUZn7.hYVUGM5iivxCNrlcChxSPW.d9cVI7s+Fr5g/8MJ7eqEIwl1OuBskpJQTZyuSORK8tw=')
ki2.log("Auth Token : " + str(ki2.authToken))
ki2.log("Timeline Token : " + str(ki2.tl.channelAccessToken))

#ki3 = LINE()
ki3 = LINE('EuYRA9r1C1LFeFo3Eie1.aleqfE7GuDFMnIRmFot+yq.LFLdFBbu8hi8DMlUpHLGavFH8pAn5c7kIfYKubYDbfU=')
ki3.log("Auth Token : " + str(ki3.authToken))
ki3.log("Timeline Token : " + str(ki3.tl.channelAccessToken))

#ki4 = LINE()
ki4 = LINE('Euy2J1QW8Ir0HOtbeUAf.XvQeWsOMx9EsZAhfPvUxlW.6r5npO1+JQKXUuL+qThtBQdY79HLVC9LU94rLinIAZk=')
...
creator = ["uee73de5ab151138537c847f3e3a15217"]
Owner = ["uee73de5ab151138537c847f3e3a15217"]
admin = ["uee73de5ab151138537c847f3e3a15217"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "uee73de5ab151138537c847f3e3a15217")
                    gye.sendMessage(to,"以上結束")
...
#==============================================================================#
                    ...
                    start = time.time()
                    gye.sendMessage(to, "正在檢查中….請您耐心稍等一會兒…")
                    elapsed_time = time.time() - start
                    gye.sendMessage(to,format(str(elapsed_time))+ "秒")
...
#==============================================================================#
                ...
                elif text.lower() in ["解散"]:    
                    #gye.leaveGroup(msg.to)
                    ais.leaveGroup(msg.to)
                    ki2.leaveGroup(msg.to)
                    ki3.leaveGroup(msg.to)
                    ki4.leaveGroup(msg.to)
                elif text.lower() in ["全部解散"]:    
                    gye.leaveGroup(msg.to)
                    ais.leaveGroup(msg.to)
                    ki2.leaveGroup(msg.to)
                    ki3.leaveGroup(msg.to)
                    ki4.leaveGroup(msg.to)      
                elif text.lower() in ["集合"]:    
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"➲ test 1")
                        ais.sendMessage(msg.to,"➲ test 2")
                        ki2.sendMessage(msg.to,"➲ test 3")
                        ki3.sendMessage(msg.to,"➲ test 4")
                        ki4.sendMessage(msg.to,"➲ test 5")
                        gye.sendMessage(msg.to,"➲ Jangan Songong Pake Sc Orang")
